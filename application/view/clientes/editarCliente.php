            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="<?php echo $respuesta['cedula']; ?>" id="txtCedula" name="txtCedula" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $respuesta['apellido']; ?>" id="txtApellido" name="txtApellido" placeholder="">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" value="<?php echo $respuesta['correo']; ?>" id="txtCorreo" name="txtCorreo" placeholder="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $respuesta['estado_civil']; ?>" id="txtEstadoCivil" name="txtEstadoCivil" placeholder="">
